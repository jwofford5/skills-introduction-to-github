...
<!-- layout: COVER PAGE
  The document should open with a dedicated cover page (no page number) containing:
    ...
    Line 8: "Version 1.0 | Effective: [DATE]" — Times New Roman 10pt, centered, black [placeholder — doc-polish will finalize]
...
<!-- format: resolved highlight #1 — "coordinating" accepted as-is; marker removed -->
...
<!-- format: resolved highlight #2 — HIGHLIGHTED PARAGRAPH notation removed; text retained as clean prose paragraph below -->
...
<!-- format: resolved highlight #3 — "gear" changed to "equipment" (more formal; resolves reviewer flag) -->
...
<!-- format: resolved highlight #4 — "Level 3 ballistic vest with plate" accepted as-is; marker removed; SME review note below -->
...
<!-- format: resolved highlights #5 and #6 — "across the county" and "The first priority" accepted as-is; markers removed -->
...
<!-- format: resolved highlight #7 — "freelancing" accepted as-is; marker removed -->
...
<!-- format: resolved highlights #8, #9, #10 — "roles", "prior to establishing a fixed command post" accepted as-is; "victim" changed to "victims" (plural, operationally accurate); all markers removed -->
