...
**Source:** URVI Framework compressed.pdf
**Date:** 2026-05-16
...
**Title:** Unified Response to Violent Incidents (URVI)
**Subtitle:** Framework for Los Angeles County Operational Guidelines
**Prepared by:** URVI Guidelines Committee, Los Angeles County Public Safety Agencies
**Type:** Government / Law Enforcement Operational Framework
**Length:** 24 pages, 13 numbered sections + References
**Estimated word count:** ~7,500 words
**Intended audience:** Los Angeles County public safety personnel — law enforcement officers, firefighters, paramedics, EMTs, incident commanders, field supervisors, dispatch centers

**Purpose:** This document establishes a coordinated, multi-agency operational framework for responding to violent incidents (active shooters, mass casualty attacks, armed barricades, civil unrest) in Los Angeles County. It defines roles, phases, command structures, communications protocols, and training requirements for law enforcement, fire, and EMS agencies operating jointly.

**Overall condition:** The document is well-written and substantively strong. The language is clear and professional. The main restoration needs are: (1) removing duplicate content, (2) resolving highlighted/flagged text that appears to represent reviewer suggestions baked into the PDF, (3) minor formatting and consistency issues, (4) one blank page at the end, and (5) several acronyms used before their formal definitions.
...
1. EXECUTIVE SUMMARY — 3
   - 1A. Preamble — 3
   - 1.1 Vision and Objectives — 3
   - 1.2 Target Audience — 3
   - 1.3 The Los Angeles County Operational Environment — 3
   - 1.4 Alignment with National Doctrine — 4
   - 1.5 Scope of Covered Incidents — 4
   - 1.6 Consequences of Breaking from Doctrine — 4
...
### 2. NATIONAL DOCTRINE FOUNDATION (Page 5)
...
### 3. INCIDENT TYPES: DYNAMIC VS. STATIC SCENARIOS (Page 6)
...
In dynamic incidents, the response tempo is at its highest. Phase 1 "Stop the Killing" dominates the early response. Law enforcement's priority is establishing Mobile Command and immediate engagement, with officers deploying toward the threat without delay. Mobile Command functions with the first officer on scene simultaneously fulfilling the incident command role while **[HIGHLIGHTED: coordinating]** the rapid formation of Contact Teams to aggressively locate and neutralize the threat.
...
**[HIGHLIGHTED PARAGRAPH: Key operational considerations for dynamic incidents include solo officer engagement, which may be necessary before backup arrives]**; RTF deployment should begin as soon as any portion of the scene becomes a viable warm zone rather than waiting for full scene clearance. Communication must be continuous and concise given the fast-changing conditions. Unified Command formation occurs in parallel with tactical operations rather than sequentially.
...
### 4. THREE-PHASE RESPONSE MODEL (Pages 7–10)
...
- **RTF Team Equipped:** Personnel identified, wearing ballistic protective equipment, carrying hemorrhage control and rapid patient movement **[HIGHLIGHTED: gear]**.
...
- **[HIGHLIGHTED] Hot Zone:** Area of active or highly suspected threat. Only law enforcement operates here. Fire/EMS do not enter under any circumstances.
- **[HIGHLIGHTED] Warm Zone:** Areas cleared by law enforcement but not fully secured. RTFs operate here with law enforcement force protection. All personnel wear ballistic protection. If security changes, the zone instantly becomes hot and RTFs withdraw.
- **[HIGHLIGHTED] Cold Zone:** Safe area with no significant risk. Command posts, staging areas, and medical treatment and transport areas are located here.
...
### 5. COMMAND PROCEDURES (Pages 11–12)
...
### 7. RESCUE TASK FORCES (RTFs) (Pages 14–15)
...
Law enforcement officers serve as the protective overwatch. They lead movement, secure corridors and doorways, maintain 360-degree force protection around **[HIGHLIGHTED: medics]**, and control the pace. Officers do not separate from the RTF or pursue independent actions. Their sole mission is RTF team safety.

Fire/EMS personnel focus on medical operations: rapid assessment, life-saving interventions (following the MARCH algorithm, e.g., tourniquets, wound packing, chest seals, airway management), triage decisions, and patient evacuation. They operate under the tactical parameters set by law enforcement; if officers say a location is not secure, **[HIGHLIGHTED: medics]** adapt accordingly.

**Deployment Triggers and Priorities**

RTF deployment requires a designated warm zone, sufficient force protection, and appropriately equipped RTF teams (URVI PPE: ballistic helmet, **[HIGHLIGHTED: Level 3 ballistic vest with plate]**, and no turnout gear). If resources are limited, command deploys to where immediate intervention will save the most lives and assigns subsequent teams as they become available.
...
### 8. COMMUNICATIONS AND INTEROPERABILITY (Pages 15–16)
...
### 9. TRAINING AND PREPAREDNESS (Pages 16–17)
...
### 12. KEY DEFINITIONS (Pages 21–22)
...
**Incident Command System (ICS):** A standardized, scalable organizational structure for managing incidents, providing clear chain of command and modular **[HIGHLIGHTED: roles]**.

**Mobile Command:** The practice of the first arriving officer serving as incident commander while still engaged in the unfolding incident, **[HIGHLIGHTED: prior to establishing a fixed command post]**.
...
**Rescue Team(s):** Law enforcement resources whose mission it is to enter the Hot Zone to rescue a **[HIGHLIGHTED: victim]**. They are configured to search for and extract the injured from the Hot Zone to the Warm Zone, a CCP, or the Treatment Area/Cold Zone.
...
### FIGURE 1: EXAMPLE BASIC URVI ORGANIZATION (Page 23)

An organizational chart showing the URVI command structure:
- **Top:** Unified Command (Law Enforcement / Fire / EMS)
- **Second tier:** Contact Group (Supervisor) [left, dark blue] | Rescue Group (Supervisor) [right, orange]
- **Third tier:** Contact Team 1, Contact Team 2 [under Contact Group] | RTF 1, RTF 2 [under Rescue Group]

*Caption: "Note: This example illustrates a basic organizational structure for coordinating threat engagement and victim rescue during a violent incident. The structure may expand or contract based on incident conditions, available resources, agency policy, and Unified Command direction."*

---

## Annotation Inventory

**PDF annotation objects extracted:** 0 (none found via pymupdf)

**Important note:** The PDF contains numerous **purple/lavender highlights** visible in the document rendering that are baked into the visual layer of the PDF — they are not stored as annotation objects and were not created using standard PDF annotation tools. These appear to be reviewer suggestions or editorial flags embedded during the PDF creation process (likely from Word with tracked changes converted to visual highlights before saving as PDF).

**Highlighted text inventory (visually identified, page by page):**

| Page | Highlighted Text | Probable Meaning |
|------|-----------------|------------------|
| 6 | "coordinating" (single word) | Possible word choice suggestion |
| 6 | Full paragraph: "Key operational considerations for dynamic incidents include solo officer engagement, which may be necessary before backup arrives" | Flagged content — possible addition, revision, or emphasis |
| 9 | "gear." (end of bullet point) | Possibly flagged for specificity — what gear exactly? |
| 9 | Three bullets (Hot Zone, Warm Zone, Cold Zone descriptions) | These duplicate the callout box immediately above — flagged as duplicate content |
| 14 | "medics" (two instances in RTF roles section) | Possible terminology flag — "medics" vs. "fire/EMS personnel" |
| 14 | "Level 3 ballistic vest with plate" | Possible specificity/accuracy flag for equipment standard |
| 18 | "across the county" | Possible scope flag |
| 18 | "The first priority" | Possible emphasis or revision flag |
| 19 | "freelancing—" | Possible terminology flag |
| 21 | "roles." (in ICS definition) | Minor flag — possible wording suggestion |
| 21 | "prior to establishing a fixed command post." (in Mobile Command definition) | Possible revision flag |
| 22 | "victim" (in Rescue Teams definition) | Possible terminology flag — "victim" vs. "patient" or "injured person" |
...
|---|---------|-------|----------|
| 1 | TOC / All sections | Section numbering inconsistency: TOC uses "1A. Preamble" then "1.1 Vision and Objectives" — mixing letter (A) and number (1.1) subsection notation. Body headings do not show section numbers at all. | Medium |
| 2 | Section 4.2 (Phase 2) | Duplicate content: Operational Zone Definitions appear first in a callout box, then immediately repeated as bullet points below. The bullets appear to be the highlighted/flagged version of the same content. | High |
| 3 | References (Section 13) | The final reference entry appears alone on page 24, leaving most of the page blank. References section should be consolidated onto one page or the last entry should flow onto page 23. | Low |

### Language
| # | Section | Issue | Severity |
|---|---------|-------|----------|
| 1 | Section 1A (Preamble) | "The leader's intent of the URVI Framework is to support..." — slightly awkward phrasing; "leader's intent" is a military term used correctly here but may be clarified as "guiding intent" for broader audiences | Low |
| 2 | Section 4.2.4 | "M.A.R. components of the MARCH algorithm" — inconsistent: uses both "M.A.R." (partial acronym with periods) and "MARCH" to refer to the same concept. Should pick one form. | Medium |
| 3 | Section 7.2 | "Pre-planned interoperability - common training, compatible radios, and interagency trust - is essential..." — uses hyphens with spaces where em-dashes (—) should be used for parenthetical phrases. | Low |
| 4 | Multiple sections | "medics" used in RTF section (pages 14–15) — document otherwise uses "fire/EMS personnel" consistently. "Medics" is informal and inconsistent with the document's terminology standard. | Medium |

### Formatting
| # | Section | Issue | Severity |
|---|---------|-------|----------|
| 1 | Throughout | Purple/lavender highlights on approximately 12 text passages across 8 pages — these represent unresolved reviewer flags that should be resolved before final publication | High |
| 2 | Section 4.2 | Duplicate zone definitions (callout box + highlighted bullets) creates visual clutter and reader confusion — one version must be removed | High |
| 3 | Section 7.2 | Hyphen-dash inconsistency in RTF Formation paragraph (should be em-dashes) | Low |
| 4 | Checklist sections (Section 11) | Checkbox format (☐) renders well in PDF; should be confirmed to translate properly to Word output | Low |

### Visuals
| # | Section | Issue | Severity |
|---|---------|-------|----------|
| 1 | Figure 1 (Page 23) | Org chart is clear and well-designed with a caption. The caption note is in italics and appropriate. No issues — this is the document's only diagram. | Low |
| 2 | Callout boxes (Sections 4 and 7) | Two callout boxes ("Three-Phase Response Model" and "Operational Zone Definitions") are visual design elements with dark red headers. These are effective but need to be faithfully reproduced in the Word output. | Medium |
| 3 | Section icons | Each major section heading uses a ⊕ symbol prefix — this is a design choice that may not render consistently in all environments and should be handled carefully in the Word output | Low |

### Layout
| # | Section | Issue | Severity |
|---|---------|-------|----------|
| 1 | Page 24 | Nearly blank page — only one reference entry. Poor page economy; references should be reorganized to fit on page 23. | Medium |
| 2 | Running header | The running header "URVI Framework - Los Angeles County Operational Guidelines" appears consistently throughout (pages 2–24). The cover page (page 1) correctly has no header. This should be replicated in the Word output. | Low |
| 3 | Page numbers | Page numbers appear in the footer on all pages except the cover. This should be maintained in the Word output. | Low |

### Professionalism
| # | Section | Issue | Severity |
|---|---------|-------|----------|
| 1 | Section 9.2 | "TECC (Tactical Emergency Casualty Care)" — defined here on first use. Good. But "TECC" also appears in the Key Definitions (Section 12). Consistent treatment. No issue. | Low |
| 2 | Section 4.2.5 | "RGS (Rescue Group Supervisor)" — introduced here but NOT included in the Key Definitions section (Section 12). Should be added to Key Definitions. | Medium |
| 3 | Section 4.2.4 | "M.A.R." — not defined as a standalone acronym; only "MARCH" is defined in Key Definitions. The partial reference to "M.A.R." should be eliminated in favor of consistent use of "MARCH." | Medium |
| 4 | Key Definitions (Section 12) | "THREAT Protocol" is defined in Section 12 but is not referenced or defined on first use anywhere in the body of the document. If it is used in the body, its first use should define it. | Low |
| 5 | Throughout | The document has no date, version number, or document control information other than "Prepared by the URVI Guidelines Committee" on the cover. A government operational document should have a version number and effective date. | Medium |

---

## Issue Summary

- **Structure:** 3 issues (1 High, 1 Medium, 1 Low)
- **Language:** 4 issues (0 High, 2 Medium, 2 Low)
- **Formatting:** 4 issues (2 High, 1 Medium, 1 Low)
- **Visuals:** 3 issues (0 High, 1 Medium, 2 Low)
- **Layout:** 3 issues (0 High, 1 Medium, 2 Low)
- **Professionalism:** 5 issues (0 High, 3 Medium, 2 Low)
- **Total:** 22 issues across 6 categories
- **Annotations found:** 0 formal annotation objects; ~12 visual highlights baked into the PDF rendering (contents cataloged above)
